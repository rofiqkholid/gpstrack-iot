...
<aside class="sidebar fixed left-0 top-0 w-[280px] md:w-sidebar h-screen bg-bg-secondary border-r border-border-color z-[1000] flex flex-col transition-transform duration-300 -translate-x-full md:translate-x-0 [&.open]:translate-x-0">
    ...
    <nav class="flex-1 py-4 px-3 overflow-y-auto">
        {{-- Section: Monitoring --}}
        <div class="text-[11px] font-semibold text-text-secondary py-2 px-3 mt-2 first:mt-0">Monitoring</div>
        ...
        {{-- Section: Service --}}
        <div class="text-[11px] font-semibold text-text-secondary py-2 px-3 mt-2 first:mt-0">Service Kendaraan</div>
        ...
        <div class="text-[11px] font-semibold text-text-secondary py-2 px-3 mt-4">Aplikasi Mobile</div>
        ...
        <div class="text-[11px] font-semibold text-text-secondary py-2 px-3 mt-4">Akun</div>
